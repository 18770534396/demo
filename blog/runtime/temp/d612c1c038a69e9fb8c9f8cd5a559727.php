<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:34:"./template/default/user_index.html";i:1504166176;s:36:"./template/default/index_header.html";i:1561033910;s:37:"./template/default/public_gradeh.html";i:1504321936;s:35:"./template/default/public_user.html";i:1504166226;s:36:"./template/default/index_footer.html";i:1514127398;}*/ ?>
<!DOCTYPE html>
<html>
<head>  
<title>我的内容 - <?php echo config('web.WEB_AUT'); ?></title>
...
<li class="layui-this"><a href="__ROOT__/user/index.html">我的内容</a></li>
<li><a href="__ROOT__/user/comment.html">我的评论</a></li>
</ul>
...
<li>
<a href="__ROOT__/thread/<?php echo $vo['id']; ?>.html" target="_blank" class="jie-title"><?php echo $vo['title']; ?></a>
<i><?php echo date("Y-m-d",$vo['time']); ?></i>
<?php if($vo['shows'] == 0): ?><a style="background: #D63131;" class="mine-edit">待审</a><?php endif; ?>
<a class="mine-edit" href="__ROOT__/edit/<?php echo $vo['id']; ?>.html">编辑</a>
